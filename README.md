...
- 🧪 **60 tests pytest** + **29 vérifications E2E boîte noire** (HTTP+WS réels
...
- Tests : `./.venv/bin/pytest -q` (60 tests) · E2E boîte noire :
  `./.venv/bin/python tools_e2e_full.py` (29 vérifications)
