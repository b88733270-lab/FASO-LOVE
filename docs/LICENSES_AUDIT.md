...
|---|---|---|
| `fastapi 0.141.1` | MIT | ✅ — maj Phase 9 (conjointe starlette 1.7) |
| `uvicorn[standard]` | BSD-3-Clause | ✅ |
| `sqlalchemy[asyncio]` | MIT | ✅ |
| `alembic` | MIT | ✅ |
| `asyncpg` | Apache-2.0 | ✅ |
| `pydantic` / `pydantic-settings` | MIT | ✅ |
| `PyJWT 2.15.0` | MIT | ✅ — maj Phase 9 (7 CVE corrigées) |
| `slowapi` | MIT | ✅ |
| `python-multipart` | Apache-2.0 | ✅ |
| `pillow 12.3.0` | BSD-CMU (HPND) | ✅ — requis images ; maj Phase 9 (audit pip-audit : 19 CVE corrigées) |
