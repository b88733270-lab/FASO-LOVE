    ...
    return RefreshIndicator(
      ...
      child: GridView.count(
        ...
        children: [
          ...
          _carte('Notifications envoyées', s.notificationsTotal,
              Icons.notifications_active, Colors.cyan.shade700),
          _carte('Appareils push', s.pushDevicesTotal, Icons.phone_android,
              Colors.blueGrey),
        ],
      ),
    );
